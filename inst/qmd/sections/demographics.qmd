...
abcdsReporter:::format_quarto("Enrollment by Year", "subsection")

atri_registry <- abcdsReporter::get_registry(examdate, apply_labels = TRUE)
...
atri_demographics <-
  abcdsReporter::get_demographics(
...
if (!is.null(params$lonidir)) {
  ...
  atri_demographics <- abcdsReporter:::loni_join(

...
#' @seealso
#' \code{\link[memoise]{memoise}}, \code{\link{clear_atri_cache}}
#' @rdname memoise_atri_get
#' @export
#' @importFrom memoise memoise

memoise_atri_get <- memoise::memoise(atri_get)
...
#' \code{get_vitals()}, etc.) to pull new data from the API.
#'
#' This function calls \code{\link[memoise]{forget()}} on the memoised object
#' \code{memoise_get_atri}, effectively resetting the cache.
#'
#' @seealso
#' \code{\link[memoise]{forget}} for details on how cache invalidation works.
#'
...
clear_atri_cache <- function() {
  memoise::forget(memoise_get_atri)
}
